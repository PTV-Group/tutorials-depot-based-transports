...
const lookupLocation = (id) => appState.depotAndCustomers.find(location => location.id === id);

const lookupDepotLocation = () => appState.locations.find(location => location.type === LocationType.Depot.toUpperCase());